...
const ACTIONS: Action[] = [
  { to: "/paper-trading", title: "Start Paper Trading", description: "Practice risk-free with live-feel charts.", icon: LineChart, tint: "from-emerald-500/20 to-emerald-500/0", cta: "Open chart" },
  ...
  { to: "/challenges", title: "Today's Challenge", description: "Earn XP and climb the ladder.", icon: Sparkles, tint: "from-amber-500/20 to-amber-500/0", cta: "Play now" },
  { to: "/leaderboard", title: "Leaderboard", description: "See where you rank this season.", icon: Trophy, tint: "from-rose-500/20 to-rose-500/0", cta: "View ranks" },
