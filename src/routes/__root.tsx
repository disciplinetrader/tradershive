...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "The gamified arena for serious traders. Risk-free paper trading, an automated journal, daily challenges, XP, leagues and global leaderboards — everything you need to become consistently profitable." },
      { property: "og:description", content: "The gamified arena for serious traders. Risk-free paper trading, an automated journal, daily challenges, XP, leagues and global leaderboards — everything you need to become consistently profitable." },
      { name: "twitter:description", content: "The gamified arena for serious traders. Risk-free paper trading, an automated journal, daily challenges, XP, leagues and global leaderboards — everything you need to become consistently profitable." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/1027a8c4-116c-4cd8-a004-449b6118b258/id-preview-3efb7cb0--237f7325-035a-4d38-a67f-36c64e02b573.lovable.app-1784305110445.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/1027a8c4-116c-4cd8-a004-449b6118b258/id-preview-3efb7cb0--237f7325-035a-4d38-a67f-36c64e02b573.lovable.app-1784305110445.png" },
    ],
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800;900&family=Space+Grotesk:wght@400;500;600;700&family=JetBrains+Mono:wght@400;500;600&display=swap",
      },
    ],
  }),
